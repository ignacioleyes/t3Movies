...
const Routes = () => {
  ...
  const AdminMoviesView = lazy(() =>
    import("../views/adminMovies/AdminMoviesView.jsx")
  );
    ...
    <Suspense fallback={<Loading />}>
      <Switch>
        <Route
          path="/"
          exact
          component={() => <Redirect to={{ pathname: "/auth" }} />}
        ></Route>
        ...
        />
        <PrivateRoute
          pageName={esi18n.viewTitles.home}
          path="/home"
          component={HomeView}
        />
        <PrivateRoute
          pageName={esi18n.viewTitles.AdminMovies}
          path="/adminMovies"
